...
public class AABB
{
	...
	public AABB(List<Double> min,List<Double> max)
	{
        		var EPSILON = 1e-16;
			...
			public void expandToContainElements( elements, startAt ) {
