...
Material::Material() {
	...
	myReflectance.kE = myReflectance.kD = myReflectance.kR =
		myReflectance.kS = myReflectance.kT = rgb();
	myReflectance.pExp = 0;
	myReflectance.indexOfRefraction = 1.0;

	myReflectance.type = Diffuse;
}
